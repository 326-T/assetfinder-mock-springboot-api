...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    private final String[] ALLOWED_ORIGIN_PATTERNS = {"http://localhost:*"};
    private final Boolean ALLOWS_CREDENTIALS = true;
    private final String[] ALLOWED_METHODS = {"GET", "HEAD", "POST", "PUT", "PATCH", "DELETE", "OPTIONS"};
    private final String[] ALLOWED_HEADERS = {"content-type", "Set-Cookie", "Authorization", "WWW-Authenticate"};
